...
import ProxyBlockedBanner from "./components/ProxyBlockedBanner";
...
function AppChrome({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative flex flex-col h-full w-full overflow-hidden">
      ...
      {/* Above `children`, so it is rendered on the login screen too. A
          blocked proxy refuses the login request itself, and Settings is
          behind the login — this bar is the only way back out. */}
      <ProxyBlockedBanner />
